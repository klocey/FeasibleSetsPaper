...
**Paragraph 1:** Uneven distributions of abundance and the aggregation of intraspecific individuals are unifying properties of ecological theories of biodiversity (McGill 2010). These properties or patterns are observed ubiquitously throughout ecological systems, and the theories that attempt to explain and predict their forms are based on a gamut of mechanisms ranging from random placement to deterministic resource preemption. 
